...
function cargarDatos() {
    ...
    // http://192.168.56.105/bookstore/usuarios/getAll
        ...
        (item,index)=>{
            if ((index>=recordIni) && (index<=recordFin)) {
                html+=`
                    ...
                    <td>${item.tipo}</td>
                    <td>
                        <button type="button" class="btn btn-primary" onclick="editarUsuario(${item.id_usr})"><i class="bi bi-pencil-square"></i></button>
                        <button type="button" class="btn btn-danger" onclick="eliminarUsuario(${item.id_usr})"><i class="bi bi-trash"></i></button>
                    </td>
                    </tr>
                `;
            }
